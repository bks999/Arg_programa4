 ...
 */
package guia12ejextra3;

import AlojamientoService.alojamientoService;
 ...
 * @author Sol
 */
public class Guia12EjExtra3 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        alojamientoService al = new alojamientoService();
        ...
        do {
            ...
            System.out.println("4 - Mostrar todos las residencias que tienen descuento.");
            System.out.println("5 - SALIR");
            opcion = sc.nextInt();

            switch (opcion) {
                case 1:
                    System.out.println(al.todosLosAlojamientos().toString());
                    break;
                case 2:
                    System.out.println(al.hotelesMasCarosMasBaratos().toString());
                    break;
                case 3:
                    System.out.println(al.campingsRestaurante().toString());
                    break;
                case 4:
                    System.out.println(al.residenciasDescuento().toString());
                case 5:
                    break;
                default:
