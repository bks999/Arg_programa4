 ...
 * @author Sol
 */
public class Hotel5Stars extends Hotel{
    ...
    public Hotel5Stars(boolean gimnasio, String nombreRestaurante, int capacidadRestaurante, int salonesDeConferencia, int suites, int limosinas, int habitaciones, int camas, int pisos, double precioHabitacion, String nombre, String direccion, String localidad, String gerente) {
    ...
    public String toString() {
        return super.toString() + 
                "\nHotel5Stars: " + "gimnasio=" + gimnasio + ", nombreRestaurante=" + nombreRestaurante + ", capacidadRestaurante=" + capacidadRestaurante + ", salonesDeConferencia=" + salonesDeConferencia + ", suites=" + suites + ", limosinas=" + limosinas + '}';
    }
