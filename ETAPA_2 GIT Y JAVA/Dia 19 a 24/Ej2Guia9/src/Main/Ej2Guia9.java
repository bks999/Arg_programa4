...
public class Ej2Guia9 {
    ...
    public static void main(String[] args) {
        ParDeNumerosServicios ob1 = new ParDeNumerosServicios();
        ob1.mostrarValores();
        System.out.println("El mayor entre los dos numeros es: " + ob1.devolverMayor());
        System.out.println("La potencia del mayor valor de la clase elevado al menor número es: " + ob1.calcularPotencia());
        System.out.println("La raiz cuadrada del numero menor es: " + ob1.calculaRaiz());
    }
